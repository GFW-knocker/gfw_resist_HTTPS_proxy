...
در آپدیت بعدی برنامه قابلیت Fragment Checker هم اضافه خواهد شد با استفاده از این قابلیت دیگه نیازی نیست به صورت دستی تمام fragment number ها رو تنظیم و تست کنید این قابلیت به صورت خودکار مناسب ترین Fragment Number رو پیشنهاد میکنه ! 
